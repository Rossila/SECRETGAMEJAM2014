...
public class CameraFollow : MonoBehaviour 
{
	...
	public float yMargin = 0.8f;		// Distance in the y axis the player can move before the camera follows.
	...
	void Awake ()
	{
		...
		player = GameObject.FindGameObjectWithTag("rabbit").transform;
	}
